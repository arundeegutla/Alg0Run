...
function AuthScreen() {
  ...
  return currentAuth ? <LogIn toggle={toggle} /> : <SignUp toggle={toggle} />;
}
        ...
        <div className="flex flex-col items-center h-full w-full justify-center">
          <div className="bg-white shadow rounded-3xl lg:w-1/3  md:w-1/2 w-full p-10">
            ...
            <button
              ...
              role="button"
              onClick={loginGoogle}
              className="hover:bg-amber-300 focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 py-3.5 px-4 border rounded-lg border-gray-700 flex items-center w-full mt-10"
            >
              <svg
                width={19}
                height={20}
