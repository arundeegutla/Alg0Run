...
export default function AlgoInfoTab({ algo }: AlgoInfoTabProps) {
  ...
  return (
    <div className='h-full overflow-auto bg-[#1e1e1e] text-lg font-mono'>
      <div className='flex h-full'>
        {/* Left Column - Algorithm Info */}
        <div className='flex-1 p-8 border-r border-[#3e3e42] overflow-auto'>
        ...
        <div className='w-96 p-6 bg-[#252526] overflow-auto'>
          <h2 className='text-2xl font-semibold text-[#569cd6] border-b border-[#3e3e42] pb-2 mb-4 font-mono'>
            Top Runs
          </h2>
          {/* Sort and Filter Controls */}
          <div className='flex items-center gap-2 mb-4'>
            <label className='text-xs text-[#858585] font-mono'>Sort by:</label>
            <select
